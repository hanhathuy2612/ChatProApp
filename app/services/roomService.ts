...
class RoomService extends Api {
  ...
  getRecent(req?: RoomQuery): Promise<DefaultApiResponse<PaginatedResponse<Room>>> {
    return this.apisauce.get<BaseResponse<PaginatedResponse<Room>>>(`api/rooms/recent`, req)
  }
